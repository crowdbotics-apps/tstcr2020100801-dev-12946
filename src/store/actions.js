...
export const test2_post__create = data => ({
  type: types.TEST2_POST__CREATE,
  data
})

export const test2_post__createSucceeded = (response, starter) => ({
  type: types.TEST2_POST__CREATE_SUCCEEDED,
  response,
  starter
})

export const test2_post__createFailed = (error, starter) => ({
  type: types.TEST2_POST__CREATE_FAILED,
  error,
  starter
})
export const registration_post_restauth_login_create = data => ({
  type: types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE,
  data
})
export const registration_post_restauth_login_createSucceeded = (
  response,
  starter
) => ({
  type: types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE_SUCCEEDED,
  response,
  starter
})
export const registration_post_restauth_login_createFailed = (
  error,
  starter
) => ({
  type: types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE_FAILED,
  error,
  starter
})
