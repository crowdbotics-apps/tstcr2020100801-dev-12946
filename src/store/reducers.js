...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE:
    case types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE_SUCCEEDED:
    case types.REGISTRATION_POST_RESTAUTH_LOGIN_CREATE_FAILED:
    ...
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        tstcrAPI: [...state.tstcrAPI, action.response]
      })
